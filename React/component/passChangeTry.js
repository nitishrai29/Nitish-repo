            ...
            <div className='container'>
                <div className='row login'>
                    ...
                    {otpForm ? <form autoComplete='off' id="otpform" method='post'>
                        ...
                        <div>
                            <Link to='/other'> <button type='button' className='btn btn-success' hidden={emailHide} onClick={getOTP} style={{ marginRight: '8rem' }}> send otp </button> </Link>
                            {/* nbsp; */}
                        ...
                        : <form autoComplete='off' id="otpform" method='post'>
                            ...
                            <h3 hidden={condown} style={{ color: "black", marginLeft: "-2rem", marginTop: '1rem' }}>Resend Otp In:: <span style={{ color: "red", fontWeight: "bold" }}> 00:{counter}</span></h3>
                            ...
                            <center> <button className="btn btn-warning btn-block" hidden={hid} onClick={showfull} style={{ marginLeft: '14rem', marginTop: '-170px' }} >Next</button></center>
                            <center> <button className="btn btn-success btn-block" hidden={showpass} onClick={resetPass} >Submit</button></center>
